...
endpoint='https://api.binance.com/api/v3/klines?symbol=BTCUSDT&interval=1d&limit=5000'
...
hist=hist.drop(['closetime','trades','takerbuyquotevolume','takerbuyassetvolume','ignore'],axis=1)
...
def line_plot(line1,line2,label1=None,label2=None,title='',lw=2):
    ...
    ax.set_ylabel('Preço[USDT]',fontsize=14)
